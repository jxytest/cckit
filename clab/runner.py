...
from clab._cli import check_claude_cli
from clab._engine.collector import StreamCollector
from clab._engine.sdk_bridge import run_sdk_query
from clab.agent import Agent
from clab.git import operations as git_ops
from clab.middleware.base import Middleware
...
class Runner:
    ...
    This is the primary execution engine of clab.  It separates
