"""Skill provisioner — deploy skills from the platform source directory into
a sandbox workspace so that ``claude-agent-sdk`` can discover them via
...
class SkillProvisioner:
    ...
    skills_dir:
        ...
        Defaults to ``platform_settings.skills_dir``.
    """

    def __init__(self, skills_dir: Path | None = None) -> None:
        self._skills_dir = skills_dir or platform_settings.skills_dir
